...
/**
 * Created by Adnan on 08-05-2018.
 */
...
public class AlarmAdapter extends CursorAdapter {
    ...
    public void setActiveImage(String active){
        if(active.equals("true")){
            mActiveImage.setImageResource(R.drawable.ic_action_notificationon);
        }else if (active.equals("false")) {
            mActiveImage.setImageResource(R.drawable.ic_action_notificationoff);
        }
    }
}
